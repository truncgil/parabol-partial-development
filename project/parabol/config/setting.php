    ...
    */
    'fallback' => [
        'localisation' => [
            ...
            'date_format'               => env('SETTING_FALLBACK_LOCALISATION_DATE_FORMAT', 'd M Y H:i'),
        ...
        'default' => [
            'currency'                  => env('SETTING_FALLBACK_DEFAULT_CURRENCY', 'TRY'),
            'locale'                    => env('SETTING_FALLBACK_DEFAULT_LOCALE', 'tr-TR'),
